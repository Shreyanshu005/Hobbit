          ...
          <aside className="hidden lg:block border-r border-black/5 bg-[#fff9ef] backdrop-blur-xl sticky top-0 h-screen w-[280px] animate-in slide-in-from-left duration-300">
            <div className="h-full flex flex-col p-6">
              ...
              <button
                ...
                className="w-full bg-[#110d19] text-white rounded-full py-3 flex items-center justify-center gap-2 hover:bg-[#110d19]/90 transition-colors shadow-lg shadow-black/10 mb-8"
              >
